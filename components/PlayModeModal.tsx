      ...
      <div className="bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 border-2 border-purple-500/30 rounded-3xl p-8 max-w-md w-full shadow-2xl relative">
        ...
        <div className="text-center mb-8">
          <h2 className="text-4xl font-black bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2">
            {isTournamentJoin ? '🏆 Join Tournament' : '🎮 Sign In to Play'}
          </h2>
          {isTournamentJoin && (
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white hover:bg-gray-100 text-gray-900 rounded-xl font-bold transition-all hover:scale-105 active:scale-95 shadow-lg"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-xl font-bold transition-all hover:scale-105 active:scale-95 shadow-lg"
          >
